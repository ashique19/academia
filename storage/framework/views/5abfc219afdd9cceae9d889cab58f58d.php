<div class="bg-sand-900 text-sand-300">
    <div class="wrap flex flex-wrap items-center justify-between gap-2 py-2 text-xs">
        <div class="flex flex-wrap items-center gap-x-5 gap-y-1">
            ...
            <span class="hidden sm:inline">A trade name of <?php echo e(str_replace(' B.V.', '', config('academia.legal_entity'))); ?></span>
        </div>
        <div class="flex flex-wrap items-center gap-x-5 gap-y-1">
            <a href="mailto:<?php echo e(config('academia.email')); ?>" class="hover:text-white"><?php echo e(config('academia.email')); ?></a>
            <a href="tel:<?php echo e(preg_replace('/\s+/', '', config('academia.phone'))); ?>" class="hover:text-white"><?php echo e(config('academia.phone')); ?></a>
        </div>
    </div>
</div>
...
>
    <div class="wrap flex items-center justify-between gap-4 py-3.5">
        ...
        <a href="<?php echo e(route('home')); ?>" class="flex items-center gap-2.5" wire:navigate>
        ...
        <nav class="hidden items-center gap-1 lg:flex" aria-label="Main">
            ...
            ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$label, $routeName]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div x-show="open" x-cloak id="mobile-nav" class="border-t border-sand-200 bg-white lg:hidden">
        <nav class="wrap grid gap-1 py-4" aria-label="Mobile">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = [
                ...
                <a href="<?php echo e(route($routeName)); ?>" wire:navigate
                   class="rounded-lg px-3 py-2.5 text-sm font-semibold text-sand-800 hover:bg-sand-50"><?php echo e($label); ?></a>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <a href="<?php echo e(route('corporate')); ?>#proposal" class="btn-green mt-2" wire:navigate>Request Proposal</a>
        </nav>
    </div>
</header>
<?php /**PATH C:\Users\Ashique\Desktop\Workplace\academia-laravel\resources\views/components/site-header.blade.php ENDPATH**/ ?>