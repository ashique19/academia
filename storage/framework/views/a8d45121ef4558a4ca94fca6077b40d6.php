<section class="bg-gradient-to-r from-orange-600 to-orange-500 py-16 text-white">
    <div class="wrap flex flex-wrap items-center justify-between gap-6">
        ...
        <div class="flex flex-wrap gap-3">
            <a href="<?php echo e(route('corporate')); ?>#proposal" class="btn-gold btn-lg" wire:navigate>Talk to an advisor</a>
            <a href="<?php echo e(route('courses.index')); ?>" class="btn-light btn-lg" wire:navigate>Browse courses</a>
        </div>
    </div>
</section>
<?php /**PATH C:\Users\Ashique\Desktop\Workplace\academia-laravel\resources\views/components/cta-band.blade.php ENDPATH**/ ?>