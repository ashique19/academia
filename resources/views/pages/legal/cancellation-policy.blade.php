<x-layouts.app title="Cancellation Policy | Academia Training Solutions">
    <div class="wrap max-w-[760px] py-14">
        <p class="eyebrow">Legal</p>
        <h1 class="mt-3">Cancellation Policy</h1>
        <p class="lede mt-3">What happens if plans change — on either side</p>
        ...
        <div class="mt-10 space-y-8">
            @include('pages.legal.partials.cancellation-policy')
        </div>
    </div>
</x-layouts.app>
